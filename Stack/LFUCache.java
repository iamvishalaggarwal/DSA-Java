...
class LFUCache {
     ...
     * 
     * minFrequency: frequency of the last linked list (the minimum frequency
     * of entire LFU cache)
     * 
     * cache: a hash map that has key to Node mapping, which used for storing
     * all nodes by their keys
     * 
     * frequencyMap: a hash map that has key to linked list mapping, which
